...
class Fps4():
    ...
    def extract_files(self, destination_path:Path, copy_path:Path, cab_extract=False, to_decompress=False):
        ...
        for file in self.files:
            ...
            #If Cab, extract
            if cab_extract:
                cab.extract_cab(destination_path / file.name, destination_path / file.name.split('.')[0])
